    ...
    <>
      ...
      <div style={{ padding: 'clamp(14px, 3vw, 28px)' }}>
        <div className="h-card" style={{ padding: 0, overflow: 'auto' }}>
          ...
          <div style={{
            display: 'grid', gridTemplateColumns: '60px 1.5fr 1.2fr 1.5fr 100px',
            ...
            <span></span><span>ຊື່</span><span>ປະເພດ</span><span>ຕິດຕໍ່</span><span></span>
          </div>
          {!guests?.length && (
          ...
          {guests?.map((g) => (
            <div key={g.id} style={{
              ...
              <EditGuestButton guest={g as User} />
            </div>
          ))}
          </div>
        </div>
